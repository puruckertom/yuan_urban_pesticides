...
# recall: this is an array of all of the output_FOL003_parent_only_Custom_Parent_daily.csv files 
...
determ <- read.csv("C:/Users/echelsvi/git/yuan_urban_pesticides/deterministic/input/FOL003/outputs/output_FOL003_parent_only_Custom_Parent_daily.csv",
...
# subset folsom sites
obs_water_folsom <- obs_water[which(obs_water$Site.ID == "FOL003"), ]
...
con <- file("C:/Users/echelsvi/git/yuan_urban_pesticides/deterministic/input/FOL003/outputs/output_FOL003_parent_only_Custom_Parent.txt")
open(con)
...
# subset folsom sites
obs_sed_folsom <- obs_sed[which(obs_sed$Site.ID == "FOL003"), ]
