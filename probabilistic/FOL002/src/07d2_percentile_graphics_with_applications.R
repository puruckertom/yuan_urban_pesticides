...
# 
# # plot apps
# calpip_sub <- calpip_s[c(367:731),]
# 
# s <- ggplot(data=calpip_sub, aes(x=date, y=bif_kgha_with_home)) +
#   geom_bar(stat="identity", fill="#525252") +
#   labs(title = "", x = "", y = "Bifenthrin Application (kg/ha)", color = "") +
#   theme_bw() +
#   theme(legend.position = "none") +
...
# # plot together
# # save figure as png
# png(filename= paste(pwcdir, "figures/percentile_applications_09_pwc_ave_h2.png", sep=""),width=20, height=10, units="in",res=300) 
# 
# g2 <- ggplotGrob(s)
# g3 <- ggplotGrob(pwc_pplot)
# g <- rbind(g2, g3, size = "first")
...
# 
# # plot apps
# calpip_sub <- calpip_s[c(732:1096),]
# 
# s <- ggplot(data=calpip_sub, aes(x=date, y=bif_kgha_with_home)) +
#   geom_bar(stat="identity", fill="#525252") +
#   labs(title = "", x = "", y = "Bifenthrin Application (kg/ha)", color = "") +
...
# # plot together
# # save figure as png
# png(filename= paste(pwcdir, "figures/percentile_applications_10_pwc_ave_h2.png", sep=""),width=20, height=10, units="in",res=300) 
# 
# g2 <- ggplotGrob(s)
# g3 <- ggplotGrob(pwc_pplot)
# g <- rbind(g2, g3, size = "first")
...
# 
# # plot apps
# calpip_sub <- calpip_s[c(1097:1461),]
# 
# s <- ggplot(data=calpip_sub, aes(x=date, y=bif_kgha_with_home)) +
#   geom_bar(stat="identity", fill="#525252") +
#   labs(title = "", x = "", y = "Bifenthrin Application (kg/ha)", color = "") +
...
# # plot together
# # save figure as png
# png(filename= paste(pwcdir, "figures/percentile_applications_11_pwc_ave_h2.png", sep=""),width=20, height=10, units="in",res=300) 
# 
# g2 <- ggplotGrob(s)
# g3 <- ggplotGrob(pwc_pplot)
# g <- rbind(g2, g3, size = "first")
...
# 
# # plot apps
# calpip_sub <- calpip_s[c(1462:1827),]
# 
# s <- ggplot(data=calpip_sub, aes(x=date, y=bif_kgha_with_home)) +
#   geom_bar(stat="identity", fill="#525252") +
#   labs(title = "", x = "", y = "Bifenthrin Application (kg/ha)", color = "") +
...
# # plot together
# # save figure as png
# png(filename= paste(pwcdir, "figures/percentile_applications_12_pwc_ave_h2.png", sep=""),width=20, height=10, units="in",res=300) 
# 
# g2 <- ggplotGrob(s)
# g3 <- ggplotGrob(pwc_pplot)
# g <- rbind(g2, g3, size = "first")
...
# 
# # plot apps
# calpip_sub <- calpip_s[c(1828:2192),]
# 
# s <- ggplot(data=calpip_sub, aes(x=date, y=bif_kgha_with_home)) +
#   geom_bar(stat="identity", fill="#525252") +
#   labs(title = "", x = "", y = "Bifenthrin Application (kg/ha)", color = "") +
...
# # plot together
# # save figure as png
# png(filename= paste(pwcdir, "figures/percentile_applications_13_pwc_ave_h2.png", sep=""),width=20, height=10, units="in",res=300) 
# 
# g2 <- ggplotGrob(s)
# g3 <- ggplotGrob(pwc_pplot)
# g <- rbind(g2, g3, size = "first")
...
# 
# # plot apps
# calpip_sub <- calpip_s[c(2193:2557),]
# 
# s <- ggplot(data=calpip_sub, aes(x=date, y=bif_kgha_with_home)) +
#   geom_bar(stat="identity", fill="#525252") +
#   labs(title = "", x = "", y = "Bifenthrin Application (kg/ha)", color = "") +
...
# # plot together
# # save figure as png
# png(filename= paste(pwcdir, "figures/percentile_applications_14_pwc_ave_h2.png", sep=""),width=20, height=10, units="in",res=300) 
# 
# g2 <- ggplotGrob(s)
# g3 <- ggplotGrob(pwc_pplot)
# g <- rbind(g2, g3, size = "first")
...
# # plot together
# # save figure as png
# png(filename= paste(pwcdir, "figures/percentile_applications_09_pwc_ave_benthic.png", sep=""),width=20, height=10, units="in",res=300) 
# 
# g2 <- ggplotGrob(s)
# g3 <- ggplotGrob(pwc_pplot)
# g <- rbind(g2, g3, size = "first")
...
# # plot together
# # save figure as png
# png(filename= paste(pwcdir, "figures/percentile_applications_10_pwc_ave_benthic.png", sep=""),width=20, height=10, units="in",res=300) 
# 
# g2 <- ggplotGrob(s)
# g3 <- ggplotGrob(pwc_pplot)
# g <- rbind(g2, g3, size = "first")
...
# # plot together
# # save figure as png
# png(filename= paste(pwcdir, "figures/percentile_applications_11_pwc_ave_benthic.png", sep=""),width=20, height=10, units="in",res=300) 
# 
# g2 <- ggplotGrob(s)
# g3 <- ggplotGrob(pwc_pplot)
# g <- rbind(g2, g3, size = "first")
...
# # plot together
# # save figure as png
# png(filename= paste(pwcdir, "figures/percentile_applications_12_pwc_ave_benthic.png", sep=""),width=20, height=10, units="in",res=300) 
# 
# g2 <- ggplotGrob(s)
# g3 <- ggplotGrob(pwc_pplot)
# g <- rbind(g2, g3, size = "first")
...
# # plot together
# # save figure as png
# png(filename= paste(pwcdir, "figures/percentile_applications_13_pwc_ave_benthic.png", sep=""),width=20, height=10, units="in",res=300) 
# 
# g2 <- ggplotGrob(s)
# g3 <- ggplotGrob(pwc_pplot)
# g <- rbind(g2, g3, size = "first")
...
# # plot together
# # save figure as png
# png(filename= paste(pwcdir, "figures/percentile_applications_14_pwc_ave_benthic.png", sep=""),width=20, height=10, units="in",res=300) 
# 
# g2 <- ggplotGrob(s)
# g3 <- ggplotGrob(pwc_pplot)
# g <- rbind(g2, g3, size = "first")
