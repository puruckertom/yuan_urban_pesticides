...
# recall: this is an array of all of the output_PGC022_parent_only_Custom_Parent_daily.csv files 
...
determ <- read.csv("C:/Users/echelsvi/git/yuan_urban_pesticides/deterministic/input/PGC022/outputs/output_PGC022_parent_only_Custom_Parent_daily.csv",
...
# subset pgc sites
obs_water_pgc <- obs_water[which(obs_water$Site.ID == "PGC022"), ]
...
con <- file("C:/Users/echelsvi/git/yuan_urban_pesticides/deterministic/input/PGC022/outputs/output_PGC022_parent_only_Custom_Parent.txt")
open(con)
...
# subset pgc sites
obs_sed_pgc <- obs_sed[which(obs_sed$Site.ID == "PGC022"), ]
