...
pwcdf_o <- read.csv(paste(pwcdir,"output/output_PGC022_parent_only_Custom_Parent_daily.csv", sep=""), header= FALSE, sep= ",",
...
# ---------------------------------------------------------------------------
  ...
  # ---------------------------- PWC Output ---------------------------------
  pwcdf <- read.csv(paste(newdir,"/","output_PGC022_parent_only_Custom_Parent_daily",".csv", sep=""), header= FALSE, sep= ",",
                    skip = 5, stringsAsFactors = FALSE, row.names=NULL)
  ...
  con_almond <- file(paste(newdir,"/","output_PGC022_parent_only_Custom_Parent",".txt", sep=""))
