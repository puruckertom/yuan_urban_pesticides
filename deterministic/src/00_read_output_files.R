...
# using .PWC files, ran deterministic models in the PWC GUI.
...
pwc_fol002 <- read.csv(paste(determdir_input,"FOL002/December-2016-FOL002_parent_only_FOL002_Custom_Parent_daily",".csv", sep=""), header= FALSE, sep= ",",
...
przm_fol002 <- read.table(paste(determdir_input,"FOL002/December-2016-FOL002_parent_only",".zts", sep=""), header= FALSE, sep= "",
...
# read pwc output file
pwc_fol003 <- read.csv(paste(determdir_input,"FOL003/December-2016-FOL003_parent_only_FOL003_Custom_Parent_daily",".csv", sep=""), header= FALSE, sep= ",",
                       skip = 5, stringsAsFactors = FALSE, row.names=NULL)
...
# read przm output file
przm_fol003 <- read.table(paste(determdir_input,"FOL003/December-2016-FOL003_parent_only",".zts", sep=""), header= FALSE, sep= "",
                          skip = 3, stringsAsFactors = FALSE, row.names=NULL)
...
# read pwc output file
pwc_pgc010 <- read.csv(paste(determdir_input,"PGC010/RosevillePGC010_PGC010_Custom_Parent_daily",".csv", sep=""), header= FALSE, sep= ",",
                       skip = 5, stringsAsFactors = FALSE, row.names=NULL)
...
# read przm output file
przm_pgc010 <- read.table(paste(determdir_input,"PGC010/RosevillePGC010",".zts", sep=""), header= FALSE, sep= "",
                          skip = 3, stringsAsFactors = FALSE, row.names=NULL)
...
# read pwc output file
pwc_pgc022 <- read.csv(paste(determdir_input,"PGC022/RosevillePGC022_PGC022_Custom_Parent_daily",".csv", sep=""), header= FALSE, sep= ",",
                       skip = 5, stringsAsFactors = FALSE, row.names=NULL)
...
# read przm output file
przm_pgc022 <- read.table(paste(determdir_input,"PGC022/RosevillePGC022",".zts", sep=""), header= FALSE, sep= "",
                          skip = 3, stringsAsFactors = FALSE, row.names=NULL)
