...
con_przm5 <- file(paste(determdir,"input/FOL003/PRZM5",".inp",sep=""))
a_old=readLines(con_przm5)
a=readLines(con_przm5)
close(con_przm5)

# update the files (weather file, PRZM output file) 
a[4]= paste(determdir,"input/FOL003/17484_grid_folsom.wea",sep="")
a[6]= paste(determdir,"input/FOL003/outputs/output.zts",sep="")



# create a przm input 
newdir <- paste0(determdir,"input/FOL003/outputs")
print(newdir)
...
# copy weather file
weather_input <- paste(determdir, "input/FOL003/17484_grid_folsom.wea", sep="")
...
con <- file(paste(determdir, "input/FOL003/vvwmTransfer",".txt",sep=""))
l_old=readLines(con)
l=readLines(con)
close(con)
...
l[69]=paste("\"",file_path_as_absolute(newdir),"/","output_FOL003_parent_only_Custom_Parent_daily.csv","\"", sep="")#
l[70]=paste("\"",file_path_as_absolute(newdir),"/","output_FOL003_parent_only_Custom_Degradate1_daily.csv","\"", sep="")#
l[71]=paste("\"",file_path_as_absolute(newdir),"/","output_FOL003_parent_only_Custom_Degradate2_daily.csv","\"", sep="")#
l[72]=paste("\"",file_path_as_absolute(newdir),"/","output_FOL003_parent_only_Custom_Parent.txt","\"", sep="")#
l[73]=paste("\"",file_path_as_absolute(newdir),"/","output_FOL003_parent_only_Custom_Degradate1.txt","\"", sep="")#
l[74]=paste("\"",file_path_as_absolute(newdir),"/","output_FOL003_parent_only_Custom_Degradate2.txt","\"", sep="")#
l[75]=paste("\"",file_path_as_absolute(newdir),"/","output_FOL003_parent_only_Custom_Parent_DEEM.rdf","\"", sep="")#
l[76]=paste("\"",file_path_as_absolute(newdir),"/","output_FOL003_parent_only_Custom_Degradate1_DEEM.rdf","\"", sep="")#
l[77]=paste("\"",file_path_as_absolute(newdir),"/","output_FOL003_parent_only_Custom_Degradate2_DEEM.rdf","\"", sep="")#
l[78]=paste("\"",file_path_as_absolute(newdir),"/","output_FOL003_parent_only_Custom_Parent_Calendex.rdf","\"", sep="")#
l[79]=paste("\"",file_path_as_absolute(newdir),"/","output_FOL003_parent_only_Custom_Degradate1_Calendex.rdf","\"", sep="")#
l[80]=paste("\"",file_path_as_absolute(newdir),"/","output_FOL003_parent_only_Custom_Degradate2_Calendex.rdf","\"", sep="")#
l[81]=paste("\"",file_path_as_absolute(newdir),"/","output_FOL003_parent_only_Custom_15_Parent.txt","\"", sep="")#
l[82]=paste("\"",file_path_as_absolute(newdir),"/","output_FOL003_parent_only_Custom_15_Degradate1.txt","\"", sep="")#
l[83]=paste("\"",file_path_as_absolute(newdir),"/","output_FOL003_parent_only_Custom_15_Degradate2.txt","\"", sep="")#
